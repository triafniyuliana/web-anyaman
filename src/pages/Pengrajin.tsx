            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200 text-left">
                  ...
                  <th className="pb-6 text-xl font-bold">Alamat</th>

                  <th className="pb-6 text-xl font-bold">Pengalaman</th>
              ...
              <tbody>
                {pengrajin.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="py-6 text-lg">{item.nama}</td>

                    <td className="py-6 text-lg">{item.email}</td>

                    <td className="py-6 text-lg">{item.telepon}</td>

                    <td className="py-6 text-lg">{item.alamat}</td>

                    <td className="py-6 text-lg">{item.pengalaman}</td>

                    <td className="py-6 text-lg">{item.tanggal}</td>
