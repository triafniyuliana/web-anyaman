...
export default function Produk() {
    ...
    const getProduk = async () => {
        try {
            const response = await getProdukApi();
    ...
    const filteredProduk = produk.filter((item) =>
        ...
        (item.keywordTrend ?? "").toLowerCase().includes(search.toLowerCase())
    );
                            ...
                            <table className="w-full">
                                <thead className="bg-[#f8f5f1]">
                                    <tr>
                                        ...
                                        <th className="px-6 py-5 text-left">Foto</th>
                                        <th className="px-6 py-5 text-left">Nama Produk</th>
                                        <th className="px-6 py-5 text-left">Keyword Trend</th>
                                        <th className="px-6 py-5 text-left">Kategori</th>
                                        <th className="px-6 py-5 text-left">Harga</th>
                                        <th className="px-6 py-5 text-left">Stok</th>
                                        <th className="px-6 py-5 text-left">Ukuran</th>
                                        <th className="px-6 py-5 text-left">Bahan</th>
